const Footer = () => {
  return (
    <footer className="px-3 py-8 transition-colors duration-200 bg-umbriagrey-background text-umbria-500 text-2">
      <div className="flex flex-col items-center justify-center">
        ...
        <div className="flex flex-col w-full mt-4 md:mt-0 md:flex-row">
          ...
          <a
            className="flex flex-col items-center justify-center w-1/5 mx-auto border-umbriagrey-border md:border-r"
          ...
          >
            ...
            <svg
              ...
              height="30"
              fill="currentColor"
              className="text-xl transition-colors duration-200 hover:text-umbria-200"
          ...
          <div className="h-px mx-auto mt-4 rounded-full md:hidden w-11 "></div>
          <div className="flex flex-col items-center justify-center flex-1 text-cetner md:mt-0 md:pl-5">
            <span>© 2021</span>
            <span className="md:mt-2">
              Created by{" "}
              <a
                className="underline underline-offset-1 hover:text-primary-gray-20"
